...
public class Hurufq extends Activity {
	...
	@Override
	 protected void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.hurufq);
		ketikarrowback();
		ketikarrowkiri();
		ketikarrowkanan();
        ...
        one = (ImageButton)this.findViewById(R.id.q);
	...
	protected void ketikarrowkanan(){
		...
		btn2.setOnClickListener(new OnClickListener(){
			public void onClick (View a2){
				Intent intent = new Intent(context,Hurufr.class);
				startActivity(intent);
			}
		});
	}
