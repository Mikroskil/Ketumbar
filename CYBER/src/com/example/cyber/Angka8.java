...
public class Angka8 extends Activity {
	...
	@Override
	 protected void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.angka8);
		ketikarrowback();
		ketikarrowkiri();
		ketikarrowkanan();
		
		
		mp = MediaPlayer.create(this, R.raw.delapan);
        one = (ImageButton)this.findViewById(R.id.delapan);
	...
	protected void ketikarrowkiri(){
		...
		btn1.setOnClickListener(new OnClickListener(){
			public void onClick (View a){
				Intent intent = new Intent(context,Angka7.class);
				startActivity(intent);
			}
		});
	}
	...
	protected void ketikarrowkanan(){
		...
		btn2.setOnClickListener(new OnClickListener(){
			public void onClick (View a2){
				Intent intent = new Intent(context,Angka9.class);
				startActivity(intent);
			}
		});
	}
