...
public class Baca6 extends Activity {
	...
	@Override
	 protected void onCreate(Bundle savedInstanceState){
		...
		mp = MediaPlayer.create(this, R.raw.mobil);
        one = (ImageButton)this.findViewById(R.id.mobil);
	...
	protected void ketikarrowkiri(){
		...
		btn1.setOnClickListener(new OnClickListener(){
			public void onClick (View a){
				Intent intent = new Intent(context,Baca5.class);
				startActivity(intent);
			}
		});
	}
	...
	protected void ketikarrowkanan(){
		...
		btn2.setOnClickListener(new OnClickListener(){
			public void onClick (View a2){
				Intent intent = new Intent(context,Baca7.class);
				startActivity(intent);
			}
		});
	}
