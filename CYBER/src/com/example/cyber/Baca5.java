...
public class Baca5 extends Activity {
	...
	@Override
	 protected void onCreate(Bundle savedInstanceState){
		...
		mp = MediaPlayer.create(this, R.raw.bola);
        one = (ImageButton)this.findViewById(R.id.bola);
	...
	protected void ketikarrowkanan(){
		...
		btn2.setOnClickListener(new OnClickListener(){
			public void onClick (View a2){
				Intent intent = new Intent(context,Baca6.class);
				startActivity(intent);
			}
		});
	}
