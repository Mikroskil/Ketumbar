...
public class Baca3 extends Activity {
	...
	@Override
	 protected void onCreate(Bundle savedInstanceState){
		...
		mp = MediaPlayer.create(this, R.raw.sapu);
        one = (ImageButton)this.findViewById(R.id.sapu);
	...
	protected void ketikarrowkiri(){
		...
		btn1.setOnClickListener(new OnClickListener(){
			public void onClick (View a){
				Intent intent = new Intent(context,Baca2.class);
				startActivity(intent);
			}
		});
	}
	...
	protected void ketikarrowkanan(){
		...
		btn2.setOnClickListener(new OnClickListener(){
			public void onClick (View a2){
				Intent intent = new Intent(context,Baca4.class);
				startActivity(intent);
			}
		});
	}
