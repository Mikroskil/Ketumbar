...
public class Hurufc extends Activity {
	...
	@Override
	 protected void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.hurufc);
		ketikarrowback();
		ketikarrowkiri();
		ketikarrowkanan();
        ...
        one = (ImageButton)this.findViewById(R.id.c);
	...
	protected void ketikarrowkiri(){
		...
		btn1.setOnClickListener(new OnClickListener(){
			public void onClick (View a){
				Intent intent = new Intent(context,Hurufb.class);
				startActivity(intent);
			}
		});
	}
	...
	protected void ketikarrowkanan(){
		...
		btn2.setOnClickListener(new OnClickListener(){
			public void onClick (View a2){
				Intent intent = new Intent(context,Hurufd.class);
				startActivity(intent);
			}
		});
	}
