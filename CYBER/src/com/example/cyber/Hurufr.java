...
public class Hurufr extends Activity {
	...
	@Override
	 protected void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.hurufr);
		ketikarrowback();
		ketikarrowkiri();
		ketikarrowkanan();
        ...
        one = (ImageButton)this.findViewById(R.id.r);
	...
	protected void ketikarrowkiri(){
		...
		btn1.setOnClickListener(new OnClickListener(){
			public void onClick (View a){
				Intent intent = new Intent(context,Hurufq.class);
				startActivity(intent);
			}
		});
	}
	...
	protected void ketikarrowkanan(){
		...
		btn2.setOnClickListener(new OnClickListener(){
			public void onClick (View a2){
				Intent intent = new Intent(context,Hurufs.class);
				startActivity(intent);
			}
		});
	}
