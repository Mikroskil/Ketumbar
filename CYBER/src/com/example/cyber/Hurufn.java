...
public class Hurufn extends Activity {
	...
	@Override
	 protected void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.hurufn);
		ketikarrowback();
		ketikarrowkiri();
		ketikarrowkanan();
        ...
        one = (ImageButton)this.findViewById(R.id.n);
	...
	protected void ketikarrowkanan(){
		...
		btn2.setOnClickListener(new OnClickListener(){
			public void onClick (View a2){
				Intent intent = new Intent(context,Hurufo.class);
				startActivity(intent);
			}
		});
	}
