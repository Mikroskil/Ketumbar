...
public class Hurufx extends Activity {
	...
	@Override
	 protected void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.hurufx);
		ketikarrowback();
		ketikarrowkiri();
		ketikarrowkanan();
        ...
        one = (ImageButton)this.findViewById(R.id.x);
	...
	protected void ketikarrowkanan(){
		...
		btn2.setOnClickListener(new OnClickListener(){
			public void onClick (View a2){
				Intent intent = new Intent(context,Hurufy.class);
				startActivity(intent);
			}
		});
	}
